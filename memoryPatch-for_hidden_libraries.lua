local function memoryPatch(offset, hex)
	...
	if offset == "" or offset == 0 or offset == nil or hex == "" or hex == 0 or hex == nil then return false end	local targetLibElfSig = "" --the target library's elf header. copy the first 72 hex (36 bytes) of target library and paste it to this string. this is required for patching offset in games with hidden library. 
